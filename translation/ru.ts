  ...
  "form": {
    "step1": {
      ...
      "height": "Рост (см)"
       ...
       "desiredLocationTitle": "Желаемая локация для поиска",
       "desiredCountry": "Желаемая страна",
       "desiredCountrySelect": "Выберите желаемую страну",
       "desiredCity": "Желаемый город",
       "desiredCityPlaceholder": "Введите желаемый город"
     },
    "step3": {
      "title": "Предпочтения",
      "seekingGender": "Ищу",
    ...
    "validation": {
      ...
      "desiredLocationCountryRequired": "Желаемая страна обязательна для заполнения",
      "desiredLocationCityRequired": "Желаемый город обязателен для заполнения",
